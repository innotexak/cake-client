...
export default function Body(){
    return(<>
        <h1 className="p-5 m-5 text-center text-xl font-bold uppercase  ">Sample Products </h1>
        <div className="w-9/11 h-9/11 md:flex justify-around items-center my-12 border-2  ">
            <div className="w-full h-auto lg:w-1/4 text-center sm:mt-10 shadow-xl ">
                ...
                <div className='w-full h-full text-md p-3'>
