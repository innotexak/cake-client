...
export default function Body(){
    return(<>
        <h1 className="p-5 m-5 text-center text-3xl font-bold uppercase  ">Sample Products </h1>
        <div className="w-9/11 h-9/11 md:flex justify-around items-center m-12 border-2  ">
